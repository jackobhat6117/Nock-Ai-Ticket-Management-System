...
export default function Page() {  // Changed from AIAssistancePage to Page
  ...
  const handleSendMessage = async () => {
    if (inputMessage.trim()) {
      ...
      try {
        const apiEndpoint = pathname === "/dashboard/noc-it" ? "/api/nocChat" : "/api/chat";
        const inputMessages = pathname === "/dashboard/noc-it" 
          ? JSON.stringify({ status_summary: inputMessage }) 
          : JSON.stringify({ question: inputMessage });
